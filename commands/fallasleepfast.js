module.exports = {
	...
	message.channel.send({embed: {
			...
			{ name: "Image 1", value: "Youre lying on a canoe on a calm lake."},
			{ name: "Image 2", value: "Youre lying on a black hammock in a black room."},
			...
			{ name: "See also", value: "SSILD, binaural_beats, sleep cycle, meditation"},
			{ name: "YT Videos", value: "[Falling Asleep Fast ELD Video](https://youtu.be/d-OFwFzscm4)\n[ASAP Science Falling Asleep FastVideo](https://youtu.be/EiYm20F9WXU)"},
