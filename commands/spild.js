module.exports = {
	...
	message.channel.send({embed: {
  	    ...
  	    fields: [
  	     	...
  	     	{ name: "Step 2", value: "Close your eyes and relax. Allow yourself to return to sleep.\nIf the conditions are favourable and you follow the above steps you should be able to enter a dream almost instantly, maintaining awareness, and therefore induce a Wake Initiated Lucid Dream (WILD)(type ld!wild if you want more information about WILD)."},
			...
			{ name: "Step 2", value: "Ignore everything and remain still, attempt to fool your brain and body into thinking that you are asleep while maintaining your consciousness. This is a good time to use the IMP technique(typr ld!imp if you want more information about IMP technique)."},
